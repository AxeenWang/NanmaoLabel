...
本次修正以「出貨標籤格式_QW075551-1.png」與「出貨標籤預覽_QW075551-1.png」作為版面參考，以下為圖片所示版面與原規格（raw_spec.md §5.1 座標表）的差異觀察：
...
> 📌 本次實作以「出貨標籤格式_QW075551-1.png」與「出貨標籤預覽_QW075551-1.png」為唯一版面權威來源，原 raw_spec.md §5.1 座標表不再適用。
